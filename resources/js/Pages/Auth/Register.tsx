...
export default function Register({
    ...
    const validateStepOne = () => {
        ...
        if (!/^\d{9,12}$/.test(data.national_id_number)) {
            nextErrors.national_id_number =
                'National ID must contain 9–12 digits.';
        }
    ...
    const submit = async (
        ...
        payload.append(
            'branch_id',
            String(registrationContext.branch.id),
        );
        ...
        try {
            const response = await fetch(
                `/api/v1/centers/${encodeURIComponent(
                    registrationContext.center.code,
    ...
    return (
        ...
        >
            ...
            <ApplicationLogo
                variant="blue"
                className="mb-7 hidden h-auto w-[185px] lg:block"
            />
            ...
            <div className="hidden lg:block">
                ...
                <p className="mt-1 text-[14px] leading-[24px] text-[#adb1ba]">
                ...
                <form onSubmit={submit} noValidate>
                    ...
                    <div className="mt-5">
                        ...
                        <div className="mt-5">
                            ...
                            {data.password_confirmation &&
                                passwordsMatch && (
                                    <p className="mt-2 flex items-center gap-1.5 text-[11px] text-[#16a34a]">
                                        <Check
                                            size={13}
                                            strokeWidth={2}
                                        />
                            ...
                            {data.password_confirmation &&
                                !passwordsMatch &&
                                !errors.password_confirmation && (
                                    <p className="mt-2 flex items-center gap-1.5 text-[11px] text-[#ef4444]">
                                        <AlertTriangle
                                            size={13}
                                        />
                        ...
                        <div className="mt-5">
                            <label className="flex cursor-pointer items-start gap-2.5">
                                ...
                                <span className="text-[12px] leading-[20px] text-[#858b97]">
                                    I agree to the{' '}
                                    <button
                                        type="button"
...
function Footer() {
    return (
        <p className="mt-8 hidden border-t border-[#e6e8ee] pt-6 text-[10px] text-[#c5c9d1] lg:block">
            © 2026 LCMS
        </p>
    );
}