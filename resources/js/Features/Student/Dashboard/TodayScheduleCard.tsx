...
export default function TodayScheduleCard({
    ...
    return (
        <section className="rounded-[16px] border border-[#e7eaf0] bg-white px-5 py-5 shadow-[0_2px_8px_rgba(16,24,40,0.06)]">
            ...
            <p className="mt-1 text-[10px] text-[#b1bac7]">
                {dateLabel}
            </p>
            ...
            {sessions.length === 0 ? (
                <div className="py-8 text-center">
                    <CalendarDays
                        className="mx-auto text-[#cbd3df]"
                        size={28}
                    />

                    <p className="mt-3 text-[11px] font-medium text-[#9ca7b8]">
                ...
                <div className="mt-5 space-y-4">
                    {sessions.map((session, index) => (
                        <div
                            key={`${session.course}-${session.time}-${index}`}
                        ...
                        >
                            ...
                            <div className="min-w-0 flex-1">
                                <h4 className="truncate text-[14px] font-extrabold text-[#242a32]">
                                    {session.course}
                                </h4>
                            ...
                            <span className="shrink-0 rounded-full bg-[#e8edf8] px-3 py-1 text-[10px] font-bold text-[#0f378c]">
                                Upcoming
                            </span>
                        </div>
                    ))}
